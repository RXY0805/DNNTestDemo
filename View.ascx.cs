...
namespace TAC.Modules.HelloWorld
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    ...
    /// 
    /// Because the control inherits from hello01ModuleBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// 
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class View : TAC.Modules.HelloWorld.Hello01ModuleBase, IActionable
    {
        ...
        protected void rptItemListOnItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                if (lnkDelete != null && lnkEdit != null && pnlAdminControls != null)
                {
                    ...
                    lnkDelete.CommandArgument = t.TextId.ToString();
                    lnkEdit.Enabled = lnkEdit.Visible = true;
                    lnkDelete.Enabled = lnkDelete.Visible = false;
                    lnkEdit.NavigateUrl = EditUrl(string.Empty, string.Empty, "Edit", "tid=" + t.TextId);
